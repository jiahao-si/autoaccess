...
import main = require('~react-router-redux~history/history');
export = main;
}
...
import main = require('~react-router-redux~redux/redux');
export = main;
}
...
declare module 'react-router-redux/react-router-redux' {
import main = require('~react-router-redux/react-router-redux');
export = main;
}
